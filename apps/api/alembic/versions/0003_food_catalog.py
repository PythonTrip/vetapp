...
NUTRIENT_SEED = [
    ...
    ("B1", "Витамин B1 (тиамин)", "vitamin", "mg"),
    ("B2", "Витамин B2 (рибофлавин)", "vitamin", "mg"),
    ("B3", "Витамин B3 (ниацин)", "vitamin", "mg"),
    ("B4", "Холин", "vitamin", "mg"),
    ("B5", "Витамин B5 (пантотеновая кислота)", "vitamin", "mg"),
    ("B6", "Витамин B6 (пиридоксин)", "vitamin", "mg"),
    ("B7", "Витамин B7 (биотин)", "vitamin", "mcg"),
    ("B9", "Витамин B9 (фолиевая кислота)", "vitamin", "mcg"),
    ("B12", "Витамин B12 (цианокобаламин)", "vitamin", "mcg"),
