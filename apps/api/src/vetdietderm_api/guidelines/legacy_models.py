"""Legacy SQL guideline schema.

The application runtime does not read these tables. They remain mapped only so
existing installations and historical Alembic migrations stay operable while
provider metadata migration is handled separately.
"""
